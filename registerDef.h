...
#define T3TCR (*(volatile unsigned int *)(0x40094004)) 		// Timer 2 Timer Control Register
#define T3CTCR (*(volatile unsigned int *)(0x40094070)) 	// Count Control Register for Timer 2 Selects between timer and counter mode
#define T3TC (*(volatile unsigned int *)(0x40094008)) 		// Timer 2 Timer Counter
#define T3MCR (*(volatile unsigned int *)(0x40094014)) 		// Match Register 3
#define T3MR0 (*(volatile unsigned int *)(0x40094018)) 		// Match Register 0
#define T3EMR (*(volatile unsigned int *)(0x4009403C)) 		// EMR Match Register for Timer 2
